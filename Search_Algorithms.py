...
def astar_search1(graph, start, goal):
...
if __name__ == '__main__':
   ...
   # print()
    ...
    print("============ AStar Search manhattan ================")
    path_astar1, explored_astar = astar_search1(graph_neighbours, '0', '61')
    print("Path_astar:", path_astar1)
    print("Explored Nodes A Star: ", explored_astar)
    print(len(explored_astar))
    print()


    print("============ AStar Search geographical================")
